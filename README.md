...
**资源本地化**
- 一键分析在线配置中的 Spider JAR、JavaScript、Python、JSON、TXT 资源
- 远程配置中的相对资源路径按配置 URL 的目录解析并下载，例如 `./jar/spider.jar`
- 下载到本地指定目录后，配置统一回写为 `./jar/...`、`./rules/...` 等相对路径
- 本地配置中的相对资源路径也支持复制到本地目录
